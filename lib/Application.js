...
var Session_1 = require("./Services/Entity/Session");
...
var Application = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (commander_1.default.create) {
                    ...
                    this.updateSession(commander_1.default.update);
                }
                else if (commander_1.default.delete) {
                    this.deleteSession(commander_1.default.delete);
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        session = new Session_1.Session(response.sessionName, response.ipAddress, response.user, response.pass);
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        if (!this.store) {
     ...
     * @param name
     */
    Application.prototype.updateSession = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
     ...
     * @param name
     */
    Application.prototype.deleteSession = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
    ...
    Application.prototype.startSession = function (session) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                child_process_1.spawn('ssh', ['-T', "" + (session.user ? session.user + '@' : null) + session.ip]);
                return [2 /*return*/];
            });
        });
    };
    ...
    Application.prototype.prepareChoices = function (sessions) {
        var choices = [];
